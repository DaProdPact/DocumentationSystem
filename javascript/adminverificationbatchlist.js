  ...
  // })
    ...
    var firstname = '';
      ...
      $.ajax({ 
       ...
       url: "adminbatchverifyaction.php?page=" + page,
       method: "GET",
       data:{
        getbatch:getbatch,
       },
       success: function (res) {
         ...
         for (request of requests){
          ...
          var dateend = my_date_format(request.date_end);
           ...
           rows += `<tr class="table-active" style="height: 15px; font-size:11px; font-weight:bold;">
                ...
                <td>${request.validity_date}</td>
               <td> 
               <i style="font-size:18px;" value="view" class="fas fa-clipboard-check text-success p-0 pe-1 approve_data" name="view" id="${request.batch_id} "></i>
        ...
        <div class="modal-footer">
          ...
          <button type="button" id="${approve}"class="btn btn-success approvebatch">Approve</button>
        </div>`;
        ...
        $('.approvebatch').on('click',function(){
          ...
          $.ajax({
                url:'adminbatchverifyaction.php',
                method:'post',
                data:{
                  approve:approve,
                  accept:accept,
                ...
                setTimeout(
                  function() 
                  {
                    window.location.href ='http://localhost/DocumentationSystem/admin/adminbatchverification.php'
