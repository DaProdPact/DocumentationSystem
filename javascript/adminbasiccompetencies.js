  ...
  $('#backunit').on('click',function(){
    ...
    var basic = $('.basicid').attr('id')
    var quali = $('.qualiid').attr('id')
    ...
    let pagedivfirst = 1;
        ...
        $('#addqualificationbtn').on('click',function(){
            ...
            let add = 'add';
            $.ajax({
              url:'adminbasicunitofcompetenciesaction.php',
              method:'post',
              data:{
                add:add,
                details:details,
            ...
            var firstname = '';
              ...
              let get_unit = 'get_unit'
              $.ajax({ 
              
               url: "adminbasicunitofcompetenciesaction.php?page=" + page,
               method: "GET",
               data:{
                get_unit:get_unit,
                basic:basic,
               ...
               success: function (res) {
                 ...
                 for (request of requests){
                      ...
                      <td style="width:35%;">${request.lmar_unit_name}</td>
                      <td>${request.lmar_unit_code}</td>
                      <td>${request.competencies_name}</td>
                       <td style="width:10%;"> 
                       <i style="font-size:18px;" value="view" class="fas fa-eye text-success p-0 pe-1 view_data" name="view" id="${request.lmar_unit_id} "></i>
