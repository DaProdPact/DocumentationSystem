     ...
     success: function (res) {
       ...
       for (cert of certs) {
        ...
        console.log(cert.attendance_id);
         ...
         <td class="text-center fw-bold p-3" style="width:80px;">${cert.lmar_smawncii_core1_1}</td>
         <td class="text-center fw-bold p-3" style="width:80px;">${cert.lmar_smawncii_core1_2}</td>
         <td class="text-center fw-bold p-3" style="width:80px;">${cert.lmar_smawncii_core1_3}</td>
         <td class="text-center fw-bold p-3" style="width:80px;">${cert.lmar_smawncii_core1_4}</td>
       ...
       $('.update_data').on('click',function(){
        ...
        <input class="form-check-input p-2 checkall1" type="checkbox" style="height:30px; width:30px;"/>
            ...
            <input class="form-check-input p-2 lmar_smawncii_core1_1" type="checkbox" style="height:30px; width:30px;"/>
            ...
            <br>
            <div class="form-check form-check-inline m-2 ms-4">
            <input class="form-check-input p-2 lmar_smawncii_core1_2" type="checkbox" style="height:30px; width:30px;"/>
            <label class="form-check-label fw-bold pt-1" for="inlineCheckbox1">L.O.2 Clean root pass 
            </label>
            </div>
            <br>
            <div class="form-check form-check-inline m-2 ms-4">
            <input class="form-check-input p-2 lmar_smawncii_core1_3" type="checkbox" style="height:30px; width:30px;"/>
            ...
            <div class="form-check form-check-inline m-2 ms-4">
            <input class="form-check-input p-2 lmar_smawncii_core1_4" type="checkbox" style="height:30px; width:30px;"/>
      ...
      checkall.on('change',function(){
        ...
        if (this.checked) {
          ...
          $(".lmar_smawncii_core1_1").prop("checked", true);
          $(".lmar_smawncii_core1_2").prop("checked", true);
          $(".lmar_smawncii_core1_3").prop("checked", true);
          $(".lmar_smawncii_core1_4").prop("checked", true);


        } 
        else{
          $('.checkall1').prop("checked", false);
          $(".lmar_smawncii_core1_1").prop("checked", false);
          $(".lmar_smawncii_core1_2").prop("checked", false);
          $(".lmar_smawncii_core1_3").prop("checked", false);
          $(".lmar_smawncii_core1_4").prop("checked", false);
      ...
      if(trainee.lmar_smawncii_core1_1 == '/' && trainee.lmar_smawncii_core1_2 == '/' && trainee.lmar_smawncii_core1_3 == '/' && trainee.lmar_smawncii_core1_4 == '/' ){
      ...
      if(trainee.lmar_smawncii_core1_1 == '/'){
        $(".lmar_smawncii_core1_1").prop("checked", true);
      ...
      if(trainee.lmar_smawncii_core1_2 == '/'){
        $(".lmar_smawncii_core1_2").prop("checked", true);
      ...
      if(trainee.lmar_smawncii_core1_3 == '/'){
        $(".lmar_smawncii_core1_3").prop("checked", true);
      ...
      if(trainee.lmar_smawncii_core1_4 == '/'){
          $(".lmar_smawncii_core1_4").prop("checked", true);
      ...
      $('#updatecom').on('click',function(){
        ...
        var isChecked1_1 = $('.lmar_smawncii_core1_1').is(':checked'); 
        var isChecked1_2 = $('.lmar_smawncii_core1_2').is(':checked'); 
        var isChecked1_3 = $('.lmar_smawncii_core1_3').is(':checked'); 
        var isChecked1_4 = $('.lmar_smawncii_core1_4').is(':checked'); 
          ...
          edit_core:edit_core,
            ...
            $('#updateModal').modal('hide')
              ...
              setTimeout(
                function() 
                {
                  window.location.href ='core_smawncii_progresschart.php'
                }, 1000);
            }
