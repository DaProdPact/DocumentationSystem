...
session_start();
$sessiontqi = $_SESSION['trainers_qualification_id'];
$getqualiquery = "SELECT * FROM `trainer_list_qualification` WHERE tl_id = '$sessiontqi' "; 
$getsqualisql = mysqli_query($connection,$getqualiquery);
while ($row = mysqli_fetch_array($getsqualisql)){
  
   $tr_id = $row['trainer_qualification_list'];
   $tr_sq = $row['selected_qualification'];
 ...
 <div class="table container mt-3 mb-0">
   ...
   >
           ...
           <form class="d-flex input-group w-auto" method="post">
             <div class="input-group">
               <div class="form-outline">
                 ...
                 <input type="hidden" class="trid" id="<?=$tr_id?>">
                 <input type="hidden" class="trsq" id="<?=$tr_sq?>">
     ...
     <thead class="rounded-1 table-responsive" style="background-color: #334a8bd0;">
       ...
       <th class="text-white">Date Start</th>
       <th class="text-white">Date End</th>
...
<div class="modal fade" id="successUpdateModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <script src="../javascript/adminbatchlist.js"></script>
