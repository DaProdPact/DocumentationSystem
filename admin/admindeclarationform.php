        ...
        <div class="table container mt-3 mb-0">
          ...
          >
            ...
            <div class="navbar navbar-primary shadow-0 py-0">
              <div class="container-fluid">
                <p
                  ...
                  >Manage Declaration Form</p
                >
                <div class="d-flex w-auto gap-3">
        
  
                  <button class="btn text-white" style="background-color: #334a8bd0;" id="addshopbtn"><i class="fas fa-cloud-download-alt"></i> &nbsp&nbsp INSERT NEW ANNEX</button>
            ...
            <thead class="rounded-1 table-responsive" style="background-color: #334a8bd0;">
              <tr>
                <th class="text-white">Declaration From</th>
            ...
            <div class="modal-content">
              <div class="modal-header bg-primary bg-opacity-75">
                ...
                <h5 class="modal-title text-white">
                  Add New Instituional Assessment
                </h5>
                <button
                  type="button"
                  class="btn-close"
              ...
              <div class="modal-body">
                ...
                <form method="post" action="adminannexinsert.php" enctype="multipart/form-data">
                <div class="row">

          <div class="col-12">

            <div class="form-outline my-2">
              <input type="text" name="annexname" class="form-control" />
              <label class="form-label" for="nttcno">Annex Name</label>
              </div>
...
$.ajax({ 
url: "admindeclarationformconnection.php?page=" + page,
method: "GET",
success: function (res) {
 ...
 for (user of users) {
   ...
   rows += `<tr class="table-active" style="height: 15px; font-size:11px; font-weight:bold;">
       <td style="width:90%;">${user.annex_name}</td>


       <td class="text-center"><a href="../pdf/${user.annex_fname}" download><i class="fas fa-cloud-arrow-down text-primary p-0" style="font-size:20px;"></i><span class="m-1 text-primary" style="font-size:20px;"></span></a></td>
   </tr>`;
 }
