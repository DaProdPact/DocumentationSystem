            ...
            <div class="navbar navbar-primary shadow-0 py-0">
              <div class="container-fluid">
                <p
                  ...
                  >Manage House Keeping</p
                >
                <div class="d-flex w-auto gap-3">
        
  
                  <button class="btn text-white" style="background-color: #334a8bd0;" id="addshopbtn"><i class="fas fa-cloud-download-alt"></i> &nbsp&nbsp INSERT NEW HOUSE KEEPING</button>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form method="post" action="admininserthouse.php" enctype="multipart/form-data">
                <div class="row">
...
$.ajax({ 
url: "adminhousekeepingconnection.php?page=" + page,
method: "GET",
success: function (res) {
 ...
 for (user of users) {
   ...
   rows += `<tr class="table-active" style="height: 15px; font-size:11px; font-weight:bold;">
       <td style="width:90%;">${user.hk_qname}</td>


       <td class="text-center"><a href="../pdf/${user.hk_fname}" download><i class="fas fa-cloud-arrow-down text-primary p-0" style="font-size:20px;"></i><span class="m-1 text-primary" style="font-size:20px;"></span></a></td>
   </tr>`;
 }
