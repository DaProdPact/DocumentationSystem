   ...
   >
     ...
     <div class="navbar navbar-primary shadow-0 py-0">
       <div class="container-fluid">
         ...
         <div class="d-flex w-auto gap-3">
           ...
           <button class="btn text-white" style="background-color: #334a8bd0;" id="addqualification"><i class="fas fa-plus-circle"></i> &nbsp&nbsp Add Qualification</button>
     ...
     <thead class="rounded-1 table-responsive" style="background-color: #334a8bd0;">
       <tr>
         ...
         <th class="text-white">Qualification Code</th>
