          ...
          >
            ...
            <div class="navbar navbar-primary shadow-0 py-0">
              <div class="container-fluid">
               <?php
               $features1 = "SELECT * FROM `add_features` WHERE add_features_id = '10'";
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form method="post" action="featues10connection.php" enctype="multipart/form-data">
                <div class="row">
...
$.ajax({ 
url: "featues10connection.php?page=" + page,
method: "GET",
success: function (res) {
 ...
 for (user of users) {
   ...
   rows += `<tr class="table-active" style="height: 15px; font-size:11px; font-weight:bold;">
       <td style="width:90%;">${user.aften_qname}</td>


       <td class="text-center"><a href="../pdf/${user.aften_fname}" download><i class="fas fa-cloud-arrow-down text-primary p-0" style="font-size:20px;"></i><span class="m-1 text-primary" style="font-size:20px;"></span></a></td>
   </tr>`;
 }
