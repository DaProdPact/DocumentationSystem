...
if($_SERVER['REQUEST_METHOD'] == 'GET'){
    ...
    $basic = $_GET['basic'];
    $quali = $_GET['quali'];
    $stmt = "SELECT COUNT(lmar_unit_id) as total FROM `lmar_unit_competencies` WHERE lmar_unit_comp = '3' AND lmar_unit_qualification = '$quali' ";
    ...
    if(isset($_POST['edit'])) {
        ...
        $addquery = "INSERT INTO `lmar_unit_competencies`(`lmar_unit_id`, `lmar_unit_name`, `lmar_unit_code`, `lmar_unit_count`, `lmar_unit_comp`, `lmar_unit_qualification`) VALUES ('','$details','$unit_code','$unit_count','3','$qualiname')";
