...
let pagedivfirst = 1;
        ...
        var firstname = '';
          ...
          $.ajax({ 
           url: "adminrtcclmissionvisionconnection.php?page=" + page,
           method: "GET",
           success: function (res) {
             ...
             for (request of requests){
                  ...
                  <td style="width:35%;">${request.rtccl_type}</td>
                  <td>${request.rtccl_name}</td>

                   <td> 
                   <i style="font-size:18px;" value="view" class="fas fa-edit text-primary p-0 pe-1 edit_data" name="view" id="${request.rtccl_id} "></i>
                   <i style="font-size:18px;" value="view" class="fas fa-trash-alt text-danger p-0 delete_data" name="view" id="${request.rtccl_id}"></i>
          ...
          `;
            ...
            $('.deletequali').on('click',function(){
             ...
             $('.edit_data').on('click',function(){
              ...
              let edit = 'edit';
              $.ajax({
                url:'adminrtcclmissionvisionconnection.php',
                method:'post',
                data:{
                  edit:edit,
                  editid:editid,
                ...
                >
                  ...
                  <div class="">
                   <textarea class="form-control" rows="4" id="details" placeholder="certification_details">${edit.rtccl_name}</textarea>
                 </div>
                  ...
                  >
                  <button type="button" class="btn btn-secondary" data-mdb-dismiss="modal">Close</button>
                  <button type="button" class="btn btn-primary update_detail" name="get_details" id="${edit.rtccl_id}">Update</button>
                  </div>
                      ...
                      success:function(response){
                        console.log(response)
                          ...
                          setTimeout(
                            function() 
                            {
                              window.location.href ='http://localhost/DocumentationSystem/admin/adminrtcclmissionvision.php'
                            }, 1000);
