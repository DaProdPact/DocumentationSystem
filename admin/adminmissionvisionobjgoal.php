...
if($mvoj == 1){
    $_SESSION['mvoj_details'] = 'Mission';
}
else if($mvoj == 2){
    $_SESSION['mvoj_details'] = 'Vision';
} 
else if($mvoj == 3){
    $_SESSION['mvoj_details'] = 'Objective';
} 
else if($mvoj == 4){
    $_SESSION['mvoj_details'] = 'Goal';
} 
 ...
 <div class="table container mt-3 mb-0">
   ...
   >
     ...
     <div class="navbar navbar-primary shadow-0 py-0">
       <div class="container-fluid">
         <p
           ...
           >Manage <?=$_SESSION['mvoj_details']?></p
         >
         <div class="d-flex w-auto gap-3">

        <button class="btn text-white" style="background-color: #334a8bd0;" id="addqualification"><i class="fas fa-plus-circle"></i> &nbsp&nbsp Add <?=$_SESSION['mvoj_details']?></button>
           ...
           <form class="d-flex input-group w-auto" method="post">
             <div class="input-group">
               <div class="form-outline">
                 ...
                 <input type="hidden" id="<?=$mvoj?>" class="mvogunit">
     ...
     <thead class="rounded-1 table-responsive" style="background-color: #334a8bd0;">
       <tr>
       <th class="text-white"><?=$_SESSION['mvoj_details']?> Details</th>
...
<nav aria-label="Page navigation example">
  ...
  <div class="">
   <textarea class="form-control" rows="4" id="details" placeholder="<?=$_SESSION['mvoj_details']?>..."></textarea>
 </div>
              ...
              <button type="button" class="btn btn-primary" id="addqualificationbtn">Add <?=$_SESSION['mvoj_details']?></button>
              </div>
...
let pagedivfirst = 1;
    ...
    $('#addqualificationbtn').on('click',function(){
        ...
        var firstname = '';
          ...
          $.ajax({ 
           url: "adminmvojaction.php?page=" + page,
           method: "GET",
           data:{
           ...
           success: function (res) {
             ...
             for (request of requests){
                  ...
                  <td style="width:90%;">${request.mvog_name}</td>


                   <td> 
                   <i style="font-size:18px;" value="view" class="fas fa-edit text-primary p-0 pe-1 edit_data" name="view" id="${request.mvog_id} "></i>
                   <i style="font-size:18px;" value="view" class="fas fa-trash-alt text-danger p-0 delete_data" name="view" id="${request.mvog_id}"></i>
             ...
             $('.edit_data').on('click',function(){
              ...
              $.ajax({
                ...
                >
                  ...
                  <div class="">
                   <textarea class="form-control" rows="4" id="details" placeholder="details">${edit.mvog_name}</textarea>
                 </div>
                  ...
                  >
                  <button type="button" class="btn btn-secondary" data-mdb-dismiss="modal">Close</button>
                  <button type="button" class="btn btn-primary update_detail" name="get_details" id="${edit.mvog_id}">Update</button>
                  </div>
