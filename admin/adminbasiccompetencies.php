     ...
     <div class="navbar navbar-primary shadow-0 py-0">
       <div class="container-fluid">
         <p
           ...
           >Manage Basic Unit of Competencies</p
         >
           ...
           <form class="d-flex input-group w-auto" method="post">
             <div class="input-group">
               <div class="form-outline">
                 <input id="search-input" type="search" name="searching" class="form-control" />
                 <label class="form-label" for="form1">Search</label>
                 <input type="hidden" id="<?=$basicunit?>" class="basicid">
                 <input type="hidden" id="<?=$qualiunit?>" class="qualiid">
               </div>
...
<div class="modal fade" id="successUpdateModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <script src="../javascript/adminbasiccompetencies.js"></script>
