 ...
 <div class="table container mt-3 mb-0">
   ...
   >
     ...
     <thead class="rounded-1 table-responsive" style="background-color: #334a8bd0;">
       <tr>
       <th class="text-white">Signatory</th>
...
let pagedivfirst = 1;
        ...
        var firstname = '';
          ...
          $.ajax({ 
           url: "adminrtcclsignatoryconnection.php?page=" + page,
           method: "GET",
           success: function (res) {
             ...
             for (request of requests){
                  ...
                  <td style="width:60%;">${request.sign_name}</td>
                  <td>${request.sign_type}</td>

                   <td> 
                   <i style="font-size:18px;" value="view" class="fas fa-edit text-primary p-0 pe-1 edit_data" name="view" id="${request.sign_id}"></i>
             ...
             $('.edit_data').on('click',function(){
              ...
              let edit = 'edit';
              $.ajax({
                url:'adminrtcclsignatoryconnection.php',
                method:'post',
                data:{
                  edit:edit,
                  editid:editid,
                ...
                >
                  ...
                  <div class="">
                   <textarea class="form-control" rows="4" id="details" placeholder="certification_details">${edit.sign_name}</textarea>
                 </div>
                  ...
                  >
                  <button type="button" class="btn btn-secondary" data-mdb-dismiss="modal">Close</button>
                  <button type="button" class="btn btn-primary update_detail" name="get_details" id="${edit.sign_id}">Update</button>
                  </div>
                      ...
                      success:function(response){
                        console.log(response)
                          ...
                          setTimeout(
                            function() 
                            {
                              window.location.href ='http://localhost/DocumentationSystem/admin/adminrtcclsignatory.php'
                            }, 1000);
