...
session_start();
$sessiontrainees = $_SESSION['admin_batch_id']; 


// $getqualiquery = "SELECT * FROM `trainer_list_qualification` WHERE tl_id = '86' "; 
// $getsqualisql = mysqli_query($connection,$getqualiquery);
// while ($row = mysqli_fetch_array($getsqualisql)){
//   //sessionpls
//    $row['trainer_qualification_list'];
//    $row['selected_qualification'];
 ...
 <div class="table container mt-3 mb-0">
   ...
   >
           ...
           <form class="d-flex input-group w-auto" method="post">
             <div class="input-group">
               <div class="form-outline">
                 ...
                 <input type="hidden" class="sessiontrainees" id="<?=$sessiontrainees?>">
     ...
     <thead class="rounded-1 table-responsive" style="background-color: #334a8bd0;">
       <tr>
       <th class="text-white">Trainees Name</th>
       <th class="text-white">Age</th>
       <th class="text-white">Contact Number</th>
       <th class="text-white">Home Address</th>
...
<div class="modal fade" id="successUpdateModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <script src="../javascript/admintraineeslist.js"></script>
