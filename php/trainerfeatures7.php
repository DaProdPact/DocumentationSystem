...
<div class="offset-2 col-10 bg-secondary bg-opacity-50">
      ...
      <div class="col-6 offset-3">
          ...
          <?php
          $featurename = "SELECT * FROM `add_features` WHERE add_features_id = 7";
          ...
          $trb = "SELECT * FROM `add_features_seven` WHERE afseven_qualification = '$sessionqualification' ";
          $trbsql = mysqli_query($connection,$trb);

          while($row = mysqli_fetch_array($trbsql)){ ?>
          <div class="row d-flex mt-3 mb-3 me-2">
            <div class="col-12 d-flex justify-content-end">
            <a href="http://localhost/DocumentationSystem/pdf/<?=$row['afseven_fname'];?>" target="_blank">  <button class="btn btn-primary lmarview" id=""><i class="fas fa-eye"></i> View </button></a>
          </div>   
