...
<link rel="stylesheet" href="../css/tipattendance.css">
    ...
    @media print {
        ...
        body *:not(#printcertracncii_common):not(#printcertracncii_common *) {
          display:none;
        }
  
        #printcertracncii_common{
...
<?php 
   ...
   require_once('./racncii_basic.php'); 
          ...
          >
            ...
            <thead class="" style="background-color: #334a8bd0;">
              <tr>
                ...
                <?php 
                $unitquery = "SELECT * FROM `lmar_unit_competencies` WHERE lmar_unit_comp = '2' AND lmar_unit_qualification = '$sessionqualification' ";
                $unitsql = mysqli_query($connection,$unitquery);
                while($urow = mysqli_fetch_array($unitsql)){ ?>


                <th colspan="<?=$urow['lmar_unit_count']?>" class="text-white text-center p-0" style="font-size: 11px; width:50px"><?=$urow['lmar_unit_name'] ?></th>
              ...
              <tr>
                ...
                <th  colspan="1" class="text-white p-0 text-center fw-bold" style="font-size: 8px;  width:8px;">1</th>
                <th  colspan="1" class="text-white p-0 text-center fw-bold" style="font-size: 8px;  width:8px;">2</th>
                <th  colspan="1" class="text-white p-0 text-center fw-bold" style="font-size: 8px;  width:8px;">3</th>
                ...
                <th  colspan="1" class="text-white p-0 text-center fw-bold" style="font-size: 8px;  width:8px;">2</th>
                <th  colspan="1" class="text-white p-0 text-center fw-bold" style="font-size: 8px;  width:8px;">3</th>
                <th  colspan="1" class="text-white p-0 text-center fw-bold" style="font-size: 8px;  width:8px;">4</th>
                ...
                <th  colspan="1" class="text-white p-0 text-center fw-bold" style="font-size: 8px;  width:8px;">3</th>
                <th  colspan="1" class="text-white p-0 text-center fw-bold" style="font-size: 8px;  width:8px;">4</th>
                <th  colspan="1" class="text-white p-0 text-center fw-bold" style="font-size: 8px;  width:8px;">5</th>
                <th  colspan="1" class="text-white p-0 text-center fw-bold" style="font-size: 8px;  width:8px;">6</th>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.3/jquery.min.js" integrity="sha512-STof4xm1wgkfm7heWqFJVn58Hm3EtS31XFaagaa8VMReCXAkQnJZ+jEy8PCC/iT18dFy95WcExNHFTqLyp72eQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    ...
    <script src="../javascript/common_racncii_progresschart.js"></script>
    <script>
