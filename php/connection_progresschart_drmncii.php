...
$readquery = "SELECT * FROM `attendance` LEFT JOIN lmar_drmncii ON  attendance.attendance_id = lmar_drmncii.lmar_drmncii_attendance_id WHERE import_trainer_id = '$session_id' AND import_qualification_id = '$sessionqualification' AND  import_batch = '$session_batch' LIMIT $start,10"; 
...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    if(isset($_POST['update'])){
        ...
        $trainees_id = $_POST['trainessid'];
        $update = array();
        $readquery = "SELECT * FROM `attendance` LEFT JOIN lmar_drmncii ON  attendance.attendance_id = lmar_drmncii.lmar_drmncii_attendance_id  WHERE attendance_id = '$trainees_id' "; 
        $readsql = mysqli_query($connection,$readquery);
          while($row = mysqli_fetch_assoc($readsql)){
              $update[] = $row;
          }
      ...
      if(isset($_POST['edit_common'])){
        ...
        $updatequery = "UPDATE `lmar_drmncii` SET `lmar_drmncii_common1_1`='$com1_1',`lmar_drmncii_common1_2`='$com1_2',`lmar_drmncii_common1_3`='$com1_3',`lmar_drmncii_common2_1`='$com2_1',`lmar_drmncii_common2_2`='$com2_1',`lmar_drmncii_common2_3`='$com2_3',`lmar_drmncii_common2_4`='$com2_4',`lmar_drmncii_common2_5`='$com2_5',`lmar_drmncii_common3_1`='$com3_1',`lmar_drmncii_common3_2`='$com3_2',`lmar_drmncii_common3_3`='$com3_3',`lmar_drmncii_common4_1`='$com4_1',`lmar_drmncii_common4_2`='$com4_2',`lmar_drmncii_common4_3`='$com4_3',`lmar_drmncii_common4_4`='$com4_4',`lmar_drmncii_common4_5`='$com4_5' WHERE lmar_drmncii_attendance_id  = '$trainessid' "; 
        $updatesql = mysqli_query($connection,$updatequery);
        
        
        if($com1_1 == '/' && $com1_2 == '/' && $com1_3 == '/' && $com2_1 == '/' && $com2_2 == '/' && $com2_3 == '/' && $com2_4 == '/' && $com2_5 == '/' && $com3_1 == '/' && $com3_2 == '/' && $com3_3 == '/' && $com4_1 == '/' && $com4_2 == '/' && $com4_3 == '/' && $com4_4 == '/' && $com4_5 == '/' ){
      ...
      if(isset($_POST['edit_core'])){
        ...
        $updatequery = "UPDATE `lmar_drmncii` SET `lmar_drmncii_core1_1`='$com1_1',`lmar_drmncii_core1_2`='$com1_2',`lmar_drmncii_core1_3`='$com1_3',`lmar_drmncii_core1_4`='$com1_4',`lmar_drmncii_core1_5`='$com1_5',`lmar_drmncii_core2_1`='$com2_1',`lmar_drmncii_core2_2`='$com2_2',`lmar_drmncii_core2_3`='$com2_3',`lmar_drmncii_core3_1`='$com3_1',`lmar_drmncii_core3_2`='$com3_2',`lmar_drmncii_core3_3`='$com3_3',`lmar_drmncii_core3_4`='$com3_4',`lmar_drmncii_core4_1`='$com4_1',`lmar_drmncii_core4_2`='$com4_2',`lmar_drmncii_core4_3`='$com4_3',`lmar_drmncii_core4_4`='$com4_4'  WHERE lmar_drmncii_attendance_id   = '$trainessid' "; 
        $updatesql = mysqli_query($connection,$updatequery);

        if($com1_1 == '/' && $com1_2 == '/' && $com1_3 == '/' && $com1_4 == '/' && $com1_5 == '/'){
        ...
        if($com4_1 == '/' && $com4_2 == '/' && $com4_3 == '/' && $com4_4 == '/'){
