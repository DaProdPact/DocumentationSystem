...
<div class="row" id="printcertsmawncii_basic">
...
<div class="row" id="printcertsmawncii_common">
<div class="row bg-white" style="height: 20vh; background-image:url(../img/headergtawncii.png); background-repeat:no-repeat; background-size: 1150px 20vh; height:20vh;">
  </div>
  ...
  <table class="table border-dark table-bordered">
         ...
         <?php
          ...
          $readquery = "SELECT * FROM `attendance` LEFT JOIN lmar_smawncii ON  attendance.attendance_id = lmar_smawncii.lmar_smawncii_attendance_id WHERE import_trainer_id = '$session_id' AND import_qualification_id = '$sessionqualification' AND  import_batch = '$session_batch' "; 
          $readsql = mysqli_query($connection,$readquery);


            $loop = 1;
            while($row = mysqli_fetch_assoc($readsql)){
              if($row['lmar_smawncii_common1_1'] == '/' && $row['lmar_smawncii_common1_2'] == '/' && $row['lmar_smawncii_common1_3'] == '/' && $row['lmar_smawncii_common1_4'] == '/' && $row['lmar_smawncii_common1_5'] == '/' ){
                $rowc1 = '/';
              }
              else{
                $rowc1 = '';
              }
              if($row['lmar_smawncii_common2_1'] == '/' && $row['lmar_smawncii_common2_2'] == '/' && $row['lmar_smawncii_common2_3'] == '/' ){
                $rowc2 = '/';
              }
              else{
                $rowc2 = '';
              }
              if($row['lmar_smawncii_common3_1'] == '/' && $row['lmar_smawncii_common3_2'] == '/' && $row['lmar_smawncii_common3_3'] == '/' && $row['lmar_smawncii_common3_4'] == '/'){
                $rowc3 = '/';
              }
              else{
                $rowc3 = '';
              }
              if($row['lmar_smawncii_common4_1'] == '/' && $row['lmar_smawncii_common4_2'] == '/' && $row['lmar_smawncii_common4_3'] == '/'){
                $rowc4 = '/';
              }
              else{
                $rowc4 = '';
              }
              if($row['lmar_smawncii_common5_1'] == '/' && $row['lmar_smawncii_common5_2'] == '/' && $row['lmar_smawncii_common5_3'] == '/' ){
                $rowc5 = '/';
              }
              else{
                $rowc5 = '';
              }
              if($row['lmar_smawncii_common6_1'] == '/' && $row['lmar_smawncii_common6_2'] == '/' && $row['lmar_smawncii_common6_3'] == '/' && $row['lmar_smawncii_common6_4'] == '/' && $row['lmar_smawncii_common6_5'] == '/' ){
                $rowc6 = '/';
              }
              else{
                $rowc6 = '';
              }
              if($row['lmar_smawncii_common7_1'] == '/' && $row['lmar_smawncii_common7_2'] == '/' && $row['lmar_smawncii_common7_3'] == '/' && $row['lmar_smawncii_common7_4'] == '/'){
                $rowc7 = '/';
              }
              else{
                $rowc7 = '';
              }
              if($row['lmar_smawncii_common8_1'] == '/' && $row['lmar_smawncii_common8_2'] == '/' && $row['lmar_smawncii_common8_3'] == '/'){
                $rowc8 = '/';
              }
              else{
                $rowc8 = '';
              }
              if($row['lmar_smawncii_common9_1'] == '/' && $row['lmar_smawncii_common9_2'] == '/' && $row['lmar_smawncii_common9_3'] == '/' && $row['lmar_smawncii_common9_4'] == '/'){
                $rowc9 = '/';
              }
              else{
                $rowc9 = '';
                ...
                echo '<tr class="border-dark text-center" style="height: 11px; font-size:8px">';
                echo '<td class="p-0 text-start ps-1">'.$loop.")".$row['FirstName']." ".$row['LastName'].'</td>';
                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_common1_1'].'</td>';
                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_common1_2'].'</td>';
                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_common1_3'].'</td>';
                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_common1_4'].'</td>';
                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_common1_5'].'</td>';
                echo '<td class="p-0">'.$rowc1.'</td>';

                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_common2_1'].'</td>';
                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_common2_2'].'</td>';
                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_common2_3'].'</td>';
                echo '<td class="p-0">'.$rowc2.'</td>';

                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_common3_1'].'</td>';
                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_common3_2'].'</td>';
                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_common3_3'].'</td>';
                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_common3_4'].'</td>';
                echo '<td class="p-0">'.$rowc3.'</td>';

                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_common4_1'].'</td>';
                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_common4_2'].'</td>';
                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_common4_3'].'</td>';
                echo '<td class="p-0">'.$rowc4.'</td>';

                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_common5_1'].'</td>';
                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_common5_2'].'</td>';
                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_common5_3'].'</td>';
                echo '<td class="p-0">'.$rowc5.'</td>';

                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_common6_1'].'</td>';
                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_common6_2'].'</td>';
                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_common6_3'].'</td>';
                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_common6_4'].'</td>';
                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_common6_5'].'</td>';
                echo '<td class="p-0">'.$rowc6.'</td>';

                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_common7_1'].'</td>';
                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_common7_2'].'</td>';
                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_common7_3'].'</td>';
                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_common7_4'].'</td>';
                echo '<td class="p-0">'.$rowc7.'</td>';

                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_common8_1'].'</td>';
                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_common8_2'].'</td>';
                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_common8_3'].'</td>';
                echo '<td class="p-0">'.$rowc8.'</td>';
                
                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_common9_1'].'</td>';
                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_common9_2'].'</td>';
                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_common9_3'].'</td>';
                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_common9_4'].'</td>';
                echo '<td class="p-0">'.$rowc9.'</td>';
...
<div class="row" id="printcertsmawncii_core">
<div class="row bg-white" style="height: 20vh; background-image:url(../img/headergtawncii.png); background-repeat:no-repeat; background-size: 1150px 20vh; height:20vh;">
  </div>
  ...
  <table class="table border-dark table-bordered">
         ...
         <?php
          ...
          $readsql = mysqli_query($connection,$readquery);
            ...
            $loop = 1;
            while($row = mysqli_fetch_assoc($readsql)){
              if($row['lmar_smawncii_core1_1'] == '/' && $row['lmar_smawncii_core1_2'] == '/' && $row['lmar_smawncii_core1_3'] == '/' && $row['lmar_smawncii_core1_4'] == '/' ){
                $rowc1 = '/';
              }
              else{
                $rowc1 = '';
                ...
                echo '<tr class="border-dark text-center" style="height: 11px; font-size:8px">';
                echo '<td class="p-0 text-start ps-1">'.$loop.")".$row['FirstName']." ".$row['LastName'].'</td>';
                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_core1_1'].'</td>';
                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_core1_2'].'</td>';
                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_core1_3'].'</td>';
                echo '<td class="p-0" style="background-color:#2f9cf0;">'.$row['lmar_smawncii_core1_4'].'</td>';
                echo '<td class="p-0">'.$rowc1.'</td>';
...
<div class="row" style="height: 100vh; background-image:url(../img/progresschartbg.png); background-repeat:no-repeat; background-size: 3200px 100vh; height:100vh;" id="printcertsmawncii_progresschart">
...
<table class="table border-dark table-bordered" style="width:100%;">
                ...
                <tr class="border-dark" style="height: 15px; font-size:15px" >
                    ...
                    <th class="p-0 text-center py-1" colspan="43" style="width:20%; font-size:15px;">COMMON COMPONENTS</th>
                    <th class="p-0 text-center py-1" colspan="5" style="width:4%; font-size:15px;">CORE COMPONENTS</th>
                    </tr>
                    <tr class="border-dark" style="height: 15px; font-size:15px" >
                    <th class="p-0 text-center" colspan="4" style="width:3%;">I</th>
                    <th class="p-0 text-center" colspan="4" style="width:3%;">II</th>
         ...
         <?php
          ...
          $readquery = "SELECT * FROM `attendance` LEFT JOIN lmar_smawncii ON  attendance.attendance_id = lmar_smawncii.lmar_smawncii_attendance_id LEFT JOIN lmar_basic_ncii ON  attendance.attendance_id = lmar_basic_ncii.lmar_basic_ncii_attendance_id WHERE import_trainer_id = '$session_id' AND import_qualification_id = '$sessionqualification' AND  import_batch = '$session_batch' "; 
          $readsql = mysqli_query($connection,$readquery);
