...
body *:not(#printcertsmawnci_progresschart):not(#printcertsmawnci_progresschart *){
  
  display:none;
}

#printcertsmawnci_progresschart{
...
<script src="../javascript/progresschart_smawnci.js"></script>
<script>
