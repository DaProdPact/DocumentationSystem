...
body *:not(#printcertoapncii_progresschart):not(#printcertoapncii_progresschart *){
  
  display:none;
}

#printcertoapncii_progresschart{
...
<script src="../javascript/progresschart_oapncii.js"></script>
<script>
