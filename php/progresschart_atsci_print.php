...
body *:not(#printcertatsnci_progresschart):not(#printcertatsnci_progresschart *){
  
  display:none;
}

#printcertatsnci_progresschart{
...
<script src="../javascript/progresschart_atsnci.js"></script>
<script>
