...
$readquery = "SELECT * FROM `attendance` LEFT JOIN lmar_racncii ON  attendance.attendance_id = lmar_racncii.lmar_racncii_attendance_id  WHERE import_trainer_id = '$session_id' AND import_qualification_id = '$sessionqualification' AND  import_batch = '$session_batch' LIMIT $start,10"; 
...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    if(isset($_POST['update'])){
        ...
        $trainees_id = $_POST['trainessid'];
        $update = array();
        $readquery = "SELECT * FROM `attendance` LEFT JOIN lmar_racncii ON  attendance.attendance_id = lmar_racncii.lmar_racncii_attendance_id  WHERE attendance_id = '$trainees_id' "; 
        $readsql = mysqli_query($connection,$readquery);
          while($row = mysqli_fetch_assoc($readsql)){
              $update[] = $row;
          }
      ...
      if(isset($_POST['edit_common'])){
        ...
        $updatequery = "UPDATE `lmar_racncii` SET `lmar_racncii_common1_1`='$com1_1',`lmar_racncii_common1_2`='$com1_2',`lmar_racncii_common1_3`='$com1_3',`lmar_racncii_common2_1`='$com2_1',`lmar_racncii_common2_2`='$com2_2',`lmar_racncii_common2_3`='$com2_3',`lmar_racncii_common3_1`='$com3_1',`lmar_racncii_common3_2`='$com3_2',`lmar_racncii_common3_3`='$com3_3',`lmar_racncii_common3_4`='$com3_4',`lmar_racncii_common4_1`='$com4_1',`lmar_racncii_common4_2`='$com4_2',`lmar_racncii_common4_3`='$com4_3',`lmar_racncii_common5_1`='$com5_1',`lmar_racncii_common5_2`='$com5_2',`lmar_racncii_common5_3`='$com5_3',`lmar_racncii_common6_1`='$com6_1',`lmar_racncii_common6_2`='$com6_2',`lmar_racncii_common6_3`='$com6_3',`lmar_racncii_common7_1`='$com7_1',`lmar_racncii_common7_2`='$com7_2',`lmar_racncii_common7_3`='$com7_3',`lmar_racncii_common8_1`='$com8_1',`lmar_racncii_common8_2`='$com8_2',`lmar_racncii_common8_3`='$com8_3',`lmar_racncii_common8_4`='$com8_4',`lmar_racncii_common8_5`='$com8_5',`lmar_racncii_common8_6`='$com8_6',`lmar_racncii_common9_1`='$com9_1',`lmar_racncii_common9_2`='$com9_2'  WHERE lmar_racncii_attendance_id  = '$trainessid' "; 
        $updatesql = mysqli_query($connection,$updatequery);

        if($com1_1 == '/' && $com1_2 == '/' && $com1_3 == '/' && $com2_1 == '/' && $com2_2 == '/' && $com2_3 == '/' && $com3_1 == '/' && $com3_2 == '/' && $com3_3 == '/' && $com3_4 == '/' && $com4_1 == '/' && $com4_2 == '/' && $com4_3 == '/' && $com5_1 == '/' && $com5_2 == '/' && $com5_3 == '/' && $com6_1 == '/' && $com6_2 == '/' && $com6_3 == '/' && $com7_1 == '/' && $com7_2 == '/' && $com7_3 == '/' && $com8_1 == '/' && $com8_2 == '/' && $com8_3 == '/' && $com9_1 == '/' && $com9_2 == '/' ){
      ...
      if(isset($_POST['edit_core'])){
        ...
        $updatequery = "UPDATE `lmar_racncii` SET `lmar_racncii_core1_1`='$com1_1',`lmar_racncii_core1_2`='$com1_2',`lmar_racncii_core1_3`='$com1_3',`lmar_racncii_core1_4`='$com1_4',`lmar_racncii_core2_1`='$com2_1',`lmar_racncii_core2_2`='$com2_2',`lmar_racncii_core2_3`='$com2_3',`lmar_racncii_core2_4`='$com2_4',`lmar_racncii_core2_5`='$com2_5',`lmar_racncii_core3_1`='$com3_1',`lmar_racncii_core3_2`='$com3_2',`lmar_racncii_core3_3`='$com3_3',`lmar_racncii_core3_4`='$com3_4' WHERE lmar_racncii_attendance_id = '$trainessid' "; 
        $updatesql = mysqli_query($connection,$updatequery);
        ...
        if($com3_1 == '/' && $com3_2 == '/' && $com3_3 == '/' && $com3_4 == '/'){
            ...
            $editquery2 = "UPDATE `attendance` SET `core3`='1' WHERE attendance_id = '$trainessid' ";
            $editsql2 = mysqli_query($connection,$editquery2);


        }
        else{
            $editquery2 = "UPDATE `attendance` SET `core3`='0' WHERE attendance_id = '$trainessid' ";
            $editsql2 = mysqli_query($connection,$editquery2);
