            ...
            <div class="navbar navbar-primary shadow-0 py-0">
              <div class="container-fluid">
                ...
                <div class="d-flex w-auto gap-3">
                  ...
                  <button class="btn text-white" style="background-color: #334a8bd0;" id="printdetails"> <i class="fa fa-print" aria-hidden="true"></i> &nbsp&nbsp Print Attendance with Details</button>
                  <button class="btn text-white" style="background-color: #334a8bd0;" id="templateprint"><i class="fa fa-print" aria-hidden="true"></i> &nbsp&nbsp Print Attendane Template</a>
...
<?php
   require_once('./attendanceform.php'); 
...
?>
    ...
    <div class="row bg-white pt-1 mt-1" id="attendancedetails">
    <?php
   require('./attendancedetails.php');
