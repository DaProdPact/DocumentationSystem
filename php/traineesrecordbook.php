...
<div class="offset-2 col-10 bg-secondary bg-opacity-50">
      ...
      <div class="col-6 offset-3">
          ...
          <div class="col-2 text-center text-white mt-2">
            <p class="bg-primary px-1 myf-custome6-font rounded-1" style="transform: rotate(-0.25turn);">TRB</p>
          </div>
          <div class="col-12 rounded-2" style="margin-left:-2.5rem; margin-top:-1.7rem; background-color:#888DCB;">
          <h5 class="ps-3 text-white myf-custome6-font  mt-2 competencies" >Trainer Record Book</h5>
          ...
          $trb = "SELECT * FROM `trb` WHERE trb_qualification = '$sessionqualification' ";
          ...
          <div class="row d-flex mt-3 mb-3 me-2">
            ...
            <a href="http://localhost/DocumentationSystem/pdf/<?=$row['trb_name'];?>" target="_blank">  <button class="btn btn-primary lmarview" id=""><i class="fas fa-eye"></i> View </button></a>
          </div>   
