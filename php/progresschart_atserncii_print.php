...
body *:not(#printcertatserncii_progresschart):not(#printcertatserncii_progresschart *){
  
  display:none;
}

#printcertatserncii_progresschart{
...
<script src="../javascript/progresschart_atserncii.js"></script>
<script>
