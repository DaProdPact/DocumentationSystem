...
body *:not(#printcertracncii_progresschart):not(#printcertracncii_progresschart *){
  
  display:none;
}

#printcertracncii_progresschart{
...
<script src="../javascript/progresschart_racncii.js"></script>
<script>
