...
<div class="col-10">
            ...
            <div class="navbar navbar-primary shadow-0 py-0">
              <div class="container-fluid">
                ...
                <div class="d-flex w-auto gap-3">
                  ...
                  <button class="btn text-white" style="background-color: #334a8bd0;" id="addbatchbtn"><i class="fas fa-cloud-download-alt"></i> &nbsp&nbsp Add Batch</button>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="row">
                  ...
                  <?php
                  $getquery = "SELECT * FROM `trainer_qualification` WHERE qualification_id = '$qualification' ";
                  $getsql = mysqli_query($connection,$getquery);   
                  while($row = mysqli_fetch_assoc($getsql)){
                    ?>
                      <input type="hidden" class="getqualificationname" id="<?= $row['qualification_title']; ?>">
  ...
  <div class="modal-dialog">
    ...
    <script src="../javascript/addbatch.js"></script>
