...
<link rel="stylesheet" href="../css/tipattendance.css">
    ...
    @media print {
        ...
        body *:not(#printcertsmawncii_core):not(#printcertsmawncii_core *) {
          display:none;
        }
  
        #printcertsmawncii_core{
        ...
        <div class="table container mt-3 mb-0">
          ...
          >
            ...
            <thead class="" style="background-color: #334a8bd0;">
              ...
              <tr>
                <th  colspan="1" class="text-white p-0 text-center fw-bold" style="font-size: 10px;  width:120px;">1</th>
                <th  colspan="1" class="text-white p-0 text-center fw-bold" style="font-size: 10px;  width:120px;">2</th>
                <th  colspan="1" class="text-white p-0 text-center fw-bold" style="font-size: 10px;  width:120px;">3</th>
                <th  colspan="1" class="text-white p-0 text-center fw-bold" style="font-size: 10px;  width:120px;">4</th>
              </tr>
            </thead>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.3/jquery.min.js" integrity="sha512-STof4xm1wgkfm7heWqFJVn58Hm3EtS31XFaagaa8VMReCXAkQnJZ+jEy8PCC/iT18dFy95WcExNHFTqLyp72eQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    ...
    <script src="../javascript/core_smawncii_progresschart.js"></script>
    <script>
