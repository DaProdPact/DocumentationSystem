...
<div class="row number m-0 mt-1" style="height:100vh">
    <?php
    ...
    if($scholar == ''){
        ...
        <div class="col-3"></div>
         ...
         <?php
            ...
            $printdetails_query = "SELECT * FROM attendance  WHERE import_trainer_id = '$id' AND import_qualification_id = '$qualification' AND  import_batch = '$batch' ORDER BY LastName ASC" ;
            ...
            while($row = mysqli_fetch_array($printdetails_sql)){
                echo '<tr class="border-dark" style="height: 13px; font-size:9px">';
