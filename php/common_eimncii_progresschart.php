...
<link rel="stylesheet" href="../css/tipattendance.css">
    ...
    @media print {
        ...
        body *:not(#printcertemncii_common):not(#printcertemncii_common *) {
          display:none;
        }
  
        #printcertemncii_common{
...
$.ajax({ 
 ...
 success: function (res) {
    ...
    rows += `<tr class="table-active p-0 update_data" style="height: 9px; width:50px; font-size:11px; "id="${cert.attendance_id}">
     ...
     $loopunit = 1;
      ...
      while($grow = mysqli_fetch_array($getsql)){ 
        ...
        ?>
         rows += `
        <td  colspan="1" class="text-black p-0 text-center fw-bold" style="font-size: 10px; width:60px;">${cert.lmar_common<?php echo $loopunit?>_<?php echo $getloopcheck?>}</td>`;
        <?php 
        $getloopcheck++;
        } 
        $getloopcheck = 1;
   ...
   <td colspan="6" class="text-center"> No Record Found </td>
    ...
    window.location.href ='common_eimncii_progresschart.php'
    console.log('s')
   }
   else{
   let certs = JSON.parse(res);
   ...
   $('.update_data').on('click',function(){
    ...
    `
          ...
          <input class="form-check-input p-2 lmar_common<?=$loopcheck?>_<?=$loopelement?>" type="checkbox" style="height:30px; width:30px;"/>
  ...
  checkall.on('change',function(){
    ...
    if (this.checked) {
      ...
      $(".lmar_common1_1").prop("checked", true);
      $(".lmar_common1_2").prop("checked", true);
      $(".lmar_common1_3").prop("checked", true);
      $(".lmar_common1_4").prop("checked", true);
      $(".lmar_common1_5").prop("checked", true);
      $(".lmar_common1_6").prop("checked", true);
      $(".lmar_common1_7").prop("checked", true);
      $(".lmar_common1_8").prop("checked", true);



      $('.checkall2').prop("checked", true);
      $(".lmar_common2_1").prop("checked", true);
      $(".lmar_common2_2").prop("checked", true);
      $(".lmar_common2_3").prop("checked", true);
      $(".lmar_common2_4").prop("checked", true);
      $(".lmar_common2_5").prop("checked", true);
      $(".lmar_common2_6").prop("checked", true);
      $(".lmar_common2_7").prop("checked", true);
      $(".lmar_common2_8").prop("checked", true);

      $('.checkall3').prop("checked", true);
      $(".lmar_common3_1").prop("checked", true);
      $(".lmar_common3_2").prop("checked", true);
      $(".lmar_common3_3").prop("checked", true);
      $(".lmar_common3_4").prop("checked", true);
      $(".lmar_common3_5").prop("checked", true);
      $(".lmar_common3_6").prop("checked", true);
      $(".lmar_common3_7").prop("checked", true);
      $(".lmar_common3_8").prop("checked", true);


      $('.checkall4').prop("checked", true);
      $(".lmar_common4_1").prop("checked", true);
      $(".lmar_common4_2").prop("checked", true);
      $(".lmar_common4_3").prop("checked", true);
      $(".lmar_common4_4").prop("checked", true);
      $(".lmar_common4_5").prop("checked", true);
      $(".lmar_common4_6").prop("checked", true);
      $(".lmar_common4_7").prop("checked", true);
      $(".lmar_common4_8").prop("checked", true);

      $('.checkall5').prop("checked", true);
      $(".lmar_common5_1").prop("checked", true);
      $(".lmar_common5_2").prop("checked", true);
      $(".lmar_common5_3").prop("checked", true);
      $(".lmar_common5_4").prop("checked", true);
      $(".lmar_common5_5").prop("checked", true);
      $(".lmar_common5_6").prop("checked", true);
      $(".lmar_common5_7").prop("checked", true);
      $(".lmar_common5_8").prop("checked", true);

      $('.checkall6').prop("checked", true);
      $(".lmar_common6_1").prop("checked", true);
      $(".lmar_common6_2").prop("checked", true);
      $(".lmar_common6_3").prop("checked", true);
      $(".lmar_common6_4").prop("checked", true);
      $(".lmar_common6_5").prop("checked", true);
      $(".lmar_common6_6").prop("checked", true);
      $(".lmar_common6_7").prop("checked", true);
      $(".lmar_common6_8").prop("checked", true);


      $('.checkall7').prop("checked", true);
      $(".lmar_common7_1").prop("checked", true);
      $(".lmar_common7_2").prop("checked", true);
      $(".lmar_common7_3").prop("checked", true);
      $(".lmar_common7_4").prop("checked", true);
      $(".lmar_common7_5").prop("checked", true);
      $(".lmar_common7_6").prop("checked", true);
      $(".lmar_common7_7").prop("checked", true);
      $(".lmar_common7_8").prop("checked", true);

      
      $('.checkall8').prop("checked", true);
      $(".lmar_common8_1").prop("checked", true);
      $(".lmar_common8_2").prop("checked", true);
      $(".lmar_common8_3").prop("checked", true);
      $(".lmar_common8_4").prop("checked", true);
      $(".lmar_common8_5").prop("checked", true);
      $(".lmar_common8_6").prop("checked", true);
      $(".lmar_common8_7").prop("checked", true);
      $(".lmar_common8_8").prop("checked", true);

            
      $('.checkall9').prop("checked", true);
      $(".lmar_common9_1").prop("checked", true);
      $(".lmar_common9_2").prop("checked", true);
      $(".lmar_common9_3").prop("checked", true);
      $(".lmar_common9_4").prop("checked", true);
      $(".lmar_common9_5").prop("checked", true);
      $(".lmar_common9_6").prop("checked", true);
      $(".lmar_common9_7").prop("checked", true);
      $(".lmar_common9_8").prop("checked", true);
      ...
      $(".lmar_common1_1").prop("checked", false);
      $(".lmar_common1_2").prop("checked", false);
      $(".lmar_common1_3").prop("checked", false);
      $(".lmar_common1_4").prop("checked", false);
      $(".lmar_common1_5").prop("checked", false);
      $(".lmar_common1_6").prop("checked", false);
      $(".lmar_common1_7").prop("checked", false);
      $(".lmar_common1_8").prop("checked", false);



      $('.checkall2').prop("checked", false);
      $(".lmar_common2_1").prop("checked", false);
      $(".lmar_common2_2").prop("checked", false);
      $(".lmar_common2_3").prop("checked", false);
      $(".lmar_common2_4").prop("checked", false);
      $(".lmar_common2_5").prop("checked", false);
      $(".lmar_common2_6").prop("checked", false);
      $(".lmar_common2_7").prop("checked", false);
      $(".lmar_common2_8").prop("checked", false);

      $('.checkall3').prop("checked", false);
      $(".lmar_common3_1").prop("checked", false);
      $(".lmar_common3_2").prop("checked", false);
      $(".lmar_common3_3").prop("checked", false);
      $(".lmar_common3_4").prop("checked", false);
      $(".lmar_common3_5").prop("checked", false);
      $(".lmar_common3_6").prop("checked", false);
      $(".lmar_common3_7").prop("checked", false);
      $(".lmar_common3_8").prop("checked", false);


      $('.checkall4').prop("checked", false);
      $(".lmar_common4_1").prop("checked", false);
      $(".lmar_common4_2").prop("checked", false);
      $(".lmar_common4_3").prop("checked", false);
      $(".lmar_common4_4").prop("checked", false);
      $(".lmar_common4_5").prop("checked", false);
      $(".lmar_common4_6").prop("checked", false);
      $(".lmar_common4_7").prop("checked", false);
      $(".lmar_common4_8").prop("checked", false);

      $('.checkall5').prop("checked", false);
      $(".lmar_common5_1").prop("checked", false);
      $(".lmar_common5_2").prop("checked", false);
      $(".lmar_common5_3").prop("checked", false);
      $(".lmar_common5_4").prop("checked", false);
      $(".lmar_common5_5").prop("checked", false);
      $(".lmar_common5_6").prop("checked", false);
      $(".lmar_common5_7").prop("checked", false);
      $(".lmar_common5_8").prop("checked", false);

      $('.checkall6').prop("checked", false);
      $(".lmar_common6_1").prop("checked", false);
      $(".lmar_common6_2").prop("checked", false);
      $(".lmar_common6_3").prop("checked", false);
      $(".lmar_common6_4").prop("checked", false);
      $(".lmar_common6_5").prop("checked", false);
      $(".lmar_common6_6").prop("checked", false);
      $(".lmar_common6_7").prop("checked", false);
      $(".lmar_common6_8").prop("checked", false);


      $('.checkall7').prop("checked", false);
      $(".lmar_common7_1").prop("checked", false);
      $(".lmar_common7_2").prop("checked", false);
      $(".lmar_common7_3").prop("checked", false);
      $(".lmar_common7_4").prop("checked", false);
      $(".lmar_common7_5").prop("checked", false);
      $(".lmar_common7_6").prop("checked", false);
      $(".lmar_common7_7").prop("checked", false);
      $(".lmar_common7_8").prop("checked", false);

      
      $('.checkall8').prop("checked", false);
      $(".lmar_common8_1").prop("checked", false);
      $(".lmar_common8_2").prop("checked", false);
      $(".lmar_common8_3").prop("checked", false);
      $(".lmar_common8_4").prop("checked", false);
      $(".lmar_common8_5").prop("checked", false);
      $(".lmar_common8_6").prop("checked", false);
      $(".lmar_common8_7").prop("checked", false);
      $(".lmar_common8_8").prop("checked", false);

            
      $('.checkall9').prop("checked", false);
      $(".lmar_common9_1").prop("checked", false);
      $(".lmar_common9_2").prop("checked", false);
      $(".lmar_common9_3").prop("checked", false);
      $(".lmar_common9_4").prop("checked", false);
      $(".lmar_common9_5").prop("checked", false);
      $(".lmar_common9_6").prop("checked", false);
      $(".lmar_common9_7").prop("checked", false);
      $(".lmar_common9_8").prop("checked", false);
...
var finalelemcom1
  ...
  <?php
$countperquery = "SELECT lmar_element_unit,COUNT(lmar_element_unit) as totalelem FROM `lmar_element` WHERE lmar_element_comp = '2' AND lmar_element_quali = '$sessionqualification' GROUP BY (lmar_element_unit)";
...
while($countss = mysqli_fetch_array($countpersql)){ 
    ...
    while($countloop <= $counting){ ?>
      if(trainee.lmar_common<?=$elementsloopings?>_<?=$countloop?> == '/'){
...
if(finalelemcom3 == 'uncheking'){
  ...
  // if(trainee.lmar_eimncii_common1_1 == '/' && trainee.lmar_eimncii_common1_2 == '/' && trainee.lmar_eimncii_common1_3 == '/' && trainee.lmar_eimncii_common1_4 == '/' ){
  ...
  $('#updatecom').on('click',function(){
    ...
    var isChecked1_1 = $('.lmar_common1_1').is(':checked'); 
    var isChecked1_2 = $('.lmar_common1_2').is(':checked'); 
    var isChecked1_3 = $('.lmar_common1_3').is(':checked'); 
    var isChecked1_4 = $('.lmar_common1_4').is(':checked');
    var isChecked1_5 = $('.lmar_common1_5').is(':checked');
    var isChecked1_6 = $('.lmar_common1_6').is(':checked');
    var isChecked1_7 = $('.lmar_common1_7').is(':checked');
    var isChecked1_8 = $('.lmar_common1_8').is(':checked');

    var isChecked2_1 = $('.lmar_common2_1').is(':checked'); 
    var isChecked2_2 = $('.lmar_common2_2').is(':checked'); 
    var isChecked2_3 = $('.lmar_common2_3').is(':checked'); 
    var isChecked2_4 = $('.lmar_common2_4').is(':checked');
    var isChecked2_5 = $('.lmar_common2_5').is(':checked');
    var isChecked2_6 = $('.lmar_common2_6').is(':checked');
    var isChecked2_7 = $('.lmar_common2_7').is(':checked');
    var isChecked2_8 = $('.lmar_common2_8').is(':checked');

    var isChecked3_1 = $('.lmar_common3_1').is(':checked'); 
    var isChecked3_2 = $('.lmar_common3_2').is(':checked'); 
    var isChecked3_3 = $('.lmar_common3_3').is(':checked'); 
    var isChecked3_4 = $('.lmar_common3_4').is(':checked');
    var isChecked3_5 = $('.lmar_common3_5').is(':checked');
    var isChecked3_6 = $('.lmar_common3_6').is(':checked');
    var isChecked3_7 = $('.lmar_common3_7').is(':checked');
    var isChecked3_8 = $('.lmar_common3_8').is(':checked');

    var isChecked4_1 = $('.lmar_common4_1').is(':checked'); 
    var isChecked4_2 = $('.lmar_common4_2').is(':checked'); 
    var isChecked4_3 = $('.lmar_common4_3').is(':checked'); 
    var isChecked4_4 = $('.lmar_common4_4').is(':checked');
    var isChecked4_5 = $('.lmar_common4_5').is(':checked');
    var isChecked4_6 = $('.lmar_common4_6').is(':checked');
    var isChecked4_7 = $('.lmar_common4_7').is(':checked');
    var isChecked4_8 = $('.lmar_common4_8').is(':checked');

    var isChecked5_1 = $('.lmar_common5_1').is(':checked'); 
    var isChecked5_2 = $('.lmar_common5_2').is(':checked'); 
    var isChecked5_3 = $('.lmar_common5_3').is(':checked'); 
    var isChecked5_4 = $('.lmar_common5_4').is(':checked');
    var isChecked5_5 = $('.lmar_common5_5').is(':checked');
    var isChecked5_6 = $('.lmar_common5_6').is(':checked');
    var isChecked5_7 = $('.lmar_common5_7').is(':checked');
    var isChecked5_8 = $('.lmar_common5_8').is(':checked');

    var isChecked6_1 = $('.lmar_common6_1').is(':checked'); 
    var isChecked6_2 = $('.lmar_common6_2').is(':checked'); 
    var isChecked6_3 = $('.lmar_common6_3').is(':checked'); 
    var isChecked6_4 = $('.lmar_common6_4').is(':checked');
    var isChecked6_5 = $('.lmar_common6_5').is(':checked');
    var isChecked6_6 = $('.lmar_common6_6').is(':checked');
    var isChecked6_7 = $('.lmar_common6_7').is(':checked');
    var isChecked6_8 = $('.lmar_common6_8').is(':checked');


    var isChecked7_1 = $('.lmar_common7_1').is(':checked'); 
    var isChecked7_2 = $('.lmar_common7_2').is(':checked'); 
    var isChecked7_3 = $('.lmar_common7_3').is(':checked'); 
    var isChecked7_4 = $('.lmar_common7_4').is(':checked');
    var isChecked7_5 = $('.lmar_common7_5').is(':checked');
    var isChecked7_6 = $('.lmar_common7_6').is(':checked');
    var isChecked7_7 = $('.lmar_common7_7').is(':checked');
    var isChecked7_8 = $('.lmar_common7_8').is(':checked');


    var isChecked8_1 = $('.lmar_common8_1').is(':checked'); 
    var isChecked8_2 = $('.lmar_common8_2').is(':checked'); 
    var isChecked8_3 = $('.lmar_common8_3').is(':checked'); 
    var isChecked8_4 = $('.lmar_common8_4').is(':checked');
    var isChecked8_5 = $('.lmar_common8_5').is(':checked');
    var isChecked8_6 = $('.lmar_common8_6').is(':checked');
    var isChecked8_7 = $('.lmar_common8_7').is(':checked');
    var isChecked8_8 = $('.lmar_common8_8').is(':checked');

    var isChecked9_1 = $('.lmar_common9_1').is(':checked'); 
    var isChecked9_2 = $('.lmar_common9_2').is(':checked'); 
    var isChecked9_3 = $('.lmar_common9_3').is(':checked'); 
    var isChecked9_4 = $('.lmar_common9_4').is(':checked');
    var isChecked9_5 = $('.lmar_common9_5').is(':checked');
    var isChecked9_6 = $('.lmar_common9_6').is(':checked');
    var isChecked9_7 = $('.lmar_common9_7').is(':checked');
    var isChecked9_8 = $('.lmar_common9_8').is(':checked');
  ...
  // }
    ...
    <?php 
        ...
        if(mysqli_num_rows($result) > 0){
          ...
          $loopchecking = '1';
          $loopelementing = '1';
          $selectingquery = "SELECT * FROM `lmar_unit_competencies` WHERE lmar_unit_qualification = '$sessionqualification' AND lmar_unit_comp = '2' ";
