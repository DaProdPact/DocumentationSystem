...
<link rel="stylesheet" href="../css/tipattendance.css">
    ...
    @media print {
        ...
        body *:not(#printcertatserncii_common):not(#printcertatserncii_common *) {
          display:none;
        }
  
        #printcertatserncii_common{
...
<?php 
   ...
   require_once('./atserncii_basic.php'); 
        ...
        <div class="table container mt-3 mb-0">
          ...
          >
            ...
            <thead class="" style="background-color: #334a8bd0;">
              <tr>
                <th rowspan="2"  colspan="3" class="text-white text-center" style="font-size: 13px; width:60px;">Trainees</th>
                <?php 
                ...
                <th colspan="<?=$urow['lmar_unit_count']?>" class="text-white text-center p-0" style="font-size: 11px; width:60px"><?=$urow['lmar_unit_name'] ?></th>
              ...
              <tr>
                ...
                <th  colspan="1" class="text-white p-0 text-center fw-bold" style="font-size: 10px;  width:10px;">1</th>
                <th  colspan="1" class="text-white p-0 text-center fw-bold" style="font-size: 10px;  width:10px;">2</th>
                <th  colspan="1" class="text-white p-0 text-center fw-bold" style="font-size: 10px;  width:10px;">3</th>
                <th  colspan="1" class="text-white p-0 text-center fw-bold" style="font-size: 10px;  width:10px;">4</th>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.3/jquery.min.js" integrity="sha512-STof4xm1wgkfm7heWqFJVn58Hm3EtS31XFaagaa8VMReCXAkQnJZ+jEy8PCC/iT18dFy95WcExNHFTqLyp72eQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    ...
    <script src="../javascript/common_atserncii_progresschart.js"></script>
    <script>
