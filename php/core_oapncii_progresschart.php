...
<link rel="stylesheet" href="../css/tipattendance.css">
    ...
    @media print {
        ...
        body *:not(#printcertoapncii_core):not(#printcertoapncii_core *) {
          display:none;
        }
  
        #printcertoapncii_core{
...
<?php 
   ...
   require_once('./oapncii_basic.php'); 
        ...
        <div class="table container mt-3 mb-0">
          ...
          >
            ...
            <thead class="" style="background-color: #334a8bd0;">
              <tr>
                <th rowspan="2"  colspan="3" class="text-white text-center" style="font-size: 13px; width:40px;">Trainees</th>
                <th  colspan="4" class="text-white text-center p-0" style="font-size: 11px; width:60px"> Raise organic chicken</th>
                <th  colspan="4" class="text-white text-center p-0" style="font-size: 11px; width:60px">Produce organic vegetables</th>
                <th  colspan="2" class="text-white text-center p-0" style="font-size: 11px; width:60px">Produce organic fertilizer</th>
                <th  colspan="3" class="text-white text-center p-0" style="font-size: 11px; width:60px">Produce organic concoctions and extracts</th>
              ...
              <tr>
                ...
                <th  colspan="1" class="text-white p-0 text-center fw-bold" style="font-size: 10px;  width:70px;">1</th>
                <th  colspan="1" class="text-white p-0 text-center fw-bold" style="font-size: 10px;  width:70px;">2</th>
                <th  colspan="1" class="text-white p-0 text-center fw-bold" style="font-size: 10px;  width:70px;">3</th>
                <th  colspan="1" class="text-white p-0 text-center fw-bold" style="font-size: 10px;  width:70px;">4</th>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.3/jquery.min.js" integrity="sha512-STof4xm1wgkfm7heWqFJVn58Hm3EtS31XFaagaa8VMReCXAkQnJZ+jEy8PCC/iT18dFy95WcExNHFTqLyp72eQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    ...
    <script src="../javascript/core_oapncii_progresschart.js"></script>
    <script>
