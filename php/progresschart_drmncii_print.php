...
body *:not(#printcertdrmncii_progresschart):not(#printcertdrmncii_progresschart *){
  
  display:none;
}

#printcertdrmncii_progresschart{
...
<script src="../javascript/progresschart_drmncii.js"></script>
<script>
