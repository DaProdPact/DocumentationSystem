...
<link rel="stylesheet" href="../css/tipattendance.css">
    ...
    @media print {
        ...
        body *:not(#printcertgtawncii_core):not(#printcertgtawncii_core *) {
          display:none;
        }
  
        #printcertgtawncii_core{
          ...
          >
            ...
            <thead class="" style="background-color: #334a8bd0;">
              <tr>
                ...
                <th  colspan="4" class="text-white text-center p-0" style="font-size: 11px; width:80px"> Weld Carbon Steel Plates Using GTAW</th>
                <th  colspan="4" class="text-white text-center p-0" style="font-size: 11px; width:80px">Weld Carbon Steel Pipes Using GTAW</th>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.3/jquery.min.js" integrity="sha512-STof4xm1wgkfm7heWqFJVn58Hm3EtS31XFaagaa8VMReCXAkQnJZ+jEy8PCC/iT18dFy95WcExNHFTqLyp72eQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    ...
    <script src="../javascript/core_gtawncii_progresschart.js"></script>
    <script>
