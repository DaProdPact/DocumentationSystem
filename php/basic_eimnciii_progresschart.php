...
<link rel="stylesheet" href="../css/tipattendance.css">
    ...
    @media print {
        ...
        body *:not(#printcerteimciii_basic):not(#printcerteimciii_basic *) {
          display:none;
        }
  
        
        #printcerteimciii_basic{
          ...
          >
            ...
            <thead class="" style="background-color: #334a8bd0;">
              <tr>
                ...
                <th  colspan="3" class="text-white p-0" style="font-size: 11px; width:50px">Lead workplace communication</th>
                <th  colspan="4" class="text-white p-0" style="font-size: 11px; width:50px">Lead small teams</th>
                <th  colspan="4" class="text-white p-0" style="font-size: 11px; width:50px">Apply critical thinking and problem solving techniques in the workplace</th>
                <th  colspan="3" class="text-white p-0" style="font-size: 11px; width:50px">Work in a diverse environment  </th>
                <th  colspan="3" class="text-white p-0" style="font-size: 11px; width:50px">Propose methods of applying learning and innovation in the organization</th>
                <th  colspan="3" class="text-white p-0" style="font-size: 11px; width:50px">Use information systematically </th>
                <th  colspan="3" class="text-white p-0" style="font-size: 11px; width:50px">Evaluate occupational safety and health work practices</th>
                <th  colspan="3" class="text-white p-0" style="font-size: 11px; width:50px">Evaluate environmental work practices </th>
                <th  colspan="3" class="text-white p-0" style="font-size: 11px; width:50px">Facilitate entrepreneurial skills for micro-small-medium enterprises(MSMEs)</th>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.3/jquery.min.js" integrity="sha512-STof4xm1wgkfm7heWqFJVn58Hm3EtS31XFaagaa8VMReCXAkQnJZ+jEy8PCC/iT18dFy95WcExNHFTqLyp72eQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    ...
    <script src="../javascript/basic_eimnciii_progresschart.js"></script>
    <script>
