...
<link rel="stylesheet" href="../css/tipattendance.css">
    ...
    @media print {
        ...
        body *:not(#printcertsmawnci_basic):not(#printcertsmawnci_basic *) {
          display:none;
        }
  
        #printcertsmawnci_basic{
...
<?php 
   ...
   require_once('./smawnci_basic.php'); 
?>
          ...
          >
            ...
            <thead class="" style="background-color: #334a8bd0;">
              <tr>
                ...
                <th  colspan="2" class="text-white p-0" style="font-size: 11px; width:50px">Receive and respond to workplace communication </th>
                <th  colspan="2" class="text-white p-0" style="font-size: 11px; width:50px">Work with others</th>
                <th  colspan="4" class="text-white p-0" style="font-size: 11px; width:50px">Solve/address routine problems</th>
                <th  colspan="3" class="text-white p-0" style="font-size: 11px; width:50px">Enhance self-management skills</th>
                <th  colspan="3" class="text-white p-0" style="font-size: 11px; width:50px">Support Innovation </th>
                <th  colspan="5" class="text-white p-0" style="font-size: 11px; width:50px">Access and maintain information</th>
                <th  colspan="3" class="text-white p-0" style="font-size: 11px; width:50px">Follow occupational safety and health policies and procedures </th>
                <th  colspan="3" class="text-white p-0" style="font-size: 11px; width:50px">Apply environmental work standards  </th>
                <th  colspan="2" class="text-white p-0" style="font-size: 11px; width:50px">Adopt entrepreneurial mindset in the workplace</th>
              ...
              <tr>
                ...
                <th  colspan="1" class="text-white p-0 text-center fw-bold" style="font-size: 10px;  width:40px;">4</th>
                ...
                <th  colspan="1" class="text-white p-0 text-center fw-bold" style="font-size: 10px;  width:40px;">3</th>
                <th  colspan="1" class="text-white p-0 text-center fw-bold" style="font-size: 10px;  width:40px;">4</th>
                <th  colspan="1" class="text-white p-0 text-center fw-bold" style="font-size: 10px;  width:40px;">5</th>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.3/jquery.min.js" integrity="sha512-STof4xm1wgkfm7heWqFJVn58Hm3EtS31XFaagaa8VMReCXAkQnJZ+jEy8PCC/iT18dFy95WcExNHFTqLyp72eQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    ...
    <script src="../javascript/basic_smawnci_progresschart.js"></script>
    <script>
