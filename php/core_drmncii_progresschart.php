...
<link rel="stylesheet" href="../css/tipattendance.css">
    ...
    @media print {
        ...
        body *:not(#printcertdrmncii_core):not(#printcertdrmncii_core *) {
          display:none;
        }
  
        #printcertdrmncii_core{
...
<?php 
   ...
   require_once('./drmncii_basic.php'); 
          ...
          >
            ...
            <thead class="" style="background-color: #334a8bd0;">
              <tr>
                ...
                <?php 
                $unitquery = "SELECT * FROM `lmar_unit_competencies` WHERE lmar_unit_comp = '3' AND lmar_unit_qualification = '$sessionqualification' ";
              ...
              <tr>
                ...
                <th  colspan="1" class="text-white p-0 text-center fw-bold" style="font-size: 10px;  width:60px;">1</th>
                <th  colspan="1" class="text-white p-0 text-center fw-bold" style="font-size: 10px;  width:60px;">2</th>
                <th  colspan="1" class="text-white p-0 text-center fw-bold" style="font-size: 10px;  width:60px;">3</th>
                <th  colspan="1" class="text-white p-0 text-center fw-bold" style="font-size: 10px;  width:60px;">4</th>
                <th  colspan="1" class="text-white p-0 text-center fw-bold" style="font-size: 10px;  width:60px;">5</th>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.3/jquery.min.js" integrity="sha512-STof4xm1wgkfm7heWqFJVn58Hm3EtS31XFaagaa8VMReCXAkQnJZ+jEy8PCC/iT18dFy95WcExNHFTqLyp72eQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    ...
    <script src="../javascript/core_drmncii_progresschart.js"></script>
    <script>
