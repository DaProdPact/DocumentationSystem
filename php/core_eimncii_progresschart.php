...
<link rel="stylesheet" href="../css/tipattendance.css">
    ...
    @media print {
        ...
        body *:not(#printcertemncii_core):not(#printcertemncii_core *) {
          display:none;
        }
  
        #printcertemncii_core{
...
$.ajax({ 
 ...
 success: function (res) {
    ...
    rows += `<tr class="table-active p-0 update_data" style="height: 9px; width:50px; font-size:11px; "id="${cert.attendance_id}">
     ...
     $loopunit = 1;
      ...
      while($grow = mysqli_fetch_array($getsql)){ 
        ...
        ?>
         rows += `
        <td  colspan="1" class="text-black p-0 text-center fw-bold" style="font-size: 10px; width:60px;">${cert.lmar_core<?php echo $loopunit?>_<?php echo $getloopcheck?>}</td>`;
        <?php 
        $getloopcheck++;
        } 
        $getloopcheck = 1;
   ...
   <td colspan="6" class="text-center"> No Record Found </td>
    ...
    window.location.href ='core_eimncii_progresschart.php'
    console.log('s')
   }
   else{
   let certs = JSON.parse(res);
   ...
   $('.update_data').on('click',function(){
    ...
    `
          ...
          <input class="form-check-input p-2 lmar_core<?=$loopcheck?>_<?=$loopelement?>" type="checkbox" style="height:30px; width:30px;"/>
  ...
  checkall.on('change',function(){
    ...
    if (this.checked) {
      ...
      $(".lmar_core1_1").prop("checked", true);
      $(".lmar_core1_2").prop("checked", true);
      $(".lmar_core1_3").prop("checked", true);
      $(".lmar_core1_4").prop("checked", true);
      $(".lmar_core1_5").prop("checked", true);
      $(".lmar_core1_6").prop("checked", true);
      $(".lmar_core1_7").prop("checked", true);
      $(".lmar_core1_8").prop("checked", true);



      $('.checkall2').prop("checked", true);
      $(".lmar_core2_1").prop("checked", true);
      $(".lmar_core2_2").prop("checked", true);
      $(".lmar_core2_3").prop("checked", true);
      $(".lmar_core2_4").prop("checked", true);
      $(".lmar_core2_5").prop("checked", true);
      $(".lmar_core2_6").prop("checked", true);
      $(".lmar_core2_7").prop("checked", true);
      $(".lmar_core2_8").prop("checked", true);

      $('.checkall3').prop("checked", true);
      $(".lmar_core3_1").prop("checked", true);
      $(".lmar_core3_2").prop("checked", true);
      $(".lmar_core3_3").prop("checked", true);
      $(".lmar_core3_4").prop("checked", true);
      $(".lmar_core3_5").prop("checked", true);
      $(".lmar_core3_6").prop("checked", true);
      $(".lmar_core3_7").prop("checked", true);
      $(".lmar_core3_8").prop("checked", true);


      $('.checkall4').prop("checked", true);
      $(".lmar_core4_1").prop("checked", true);
      $(".lmar_core4_2").prop("checked", true);
      $(".lmar_core4_3").prop("checked", true);
      $(".lmar_core4_4").prop("checked", true);
      $(".lmar_core4_5").prop("checked", true);
      $(".lmar_core4_6").prop("checked", true);
      $(".lmar_core4_7").prop("checked", true);
      $(".lmar_core4_8").prop("checked", true);

      $('.checkall5').prop("checked", true);
      $(".lmar_core5_1").prop("checked", true);
      $(".lmar_core5_2").prop("checked", true);
      $(".lmar_core5_3").prop("checked", true);
      $(".lmar_core5_4").prop("checked", true);
      $(".lmar_core5_5").prop("checked", true);
      $(".lmar_core5_6").prop("checked", true);
      $(".lmar_core5_7").prop("checked", true);
      $(".lmar_core5_8").prop("checked", true);

      $('.checkall6').prop("checked", true);
      $(".lmar_core6_1").prop("checked", true);
      $(".lmar_core6_2").prop("checked", true);
      $(".lmar_core6_3").prop("checked", true);
      $(".lmar_core6_4").prop("checked", true);
      $(".lmar_core6_5").prop("checked", true);
      $(".lmar_core6_6").prop("checked", true);
      $(".lmar_core6_7").prop("checked", true);
      $(".lmar_core6_8").prop("checked", true);


      $('.checkall7').prop("checked", true);
      $(".lmar_core7_1").prop("checked", true);
      $(".lmar_core7_2").prop("checked", true);
      $(".lmar_core7_3").prop("checked", true);
      $(".lmar_core7_4").prop("checked", true);
      $(".lmar_core7_5").prop("checked", true);
      $(".lmar_core7_6").prop("checked", true);
      $(".lmar_core7_7").prop("checked", true);
      $(".lmar_core7_8").prop("checked", true);

      
      $('.checkall8').prop("checked", true);
      $(".lmar_core8_1").prop("checked", true);
      $(".lmar_core8_2").prop("checked", true);
      $(".lmar_core8_3").prop("checked", true);
      $(".lmar_core8_4").prop("checked", true);
      $(".lmar_core8_5").prop("checked", true);
      $(".lmar_core8_6").prop("checked", true);
      $(".lmar_core8_7").prop("checked", true);
      $(".lmar_core8_8").prop("checked", true);

            
      $('.checkall9').prop("checked", true);
      $(".lmar_core9_1").prop("checked", true);
      $(".lmar_core9_2").prop("checked", true);
      $(".lmar_core9_3").prop("checked", true);
      $(".lmar_core9_4").prop("checked", true);
      $(".lmar_core9_5").prop("checked", true);
      $(".lmar_core9_6").prop("checked", true);
      $(".lmar_core9_7").prop("checked", true);
      $(".lmar_core9_8").prop("checked", true);
      ...
      $(".lmar_core1_1").prop("checked", false);
      $(".lmar_core1_2").prop("checked", false);
      $(".lmar_core1_3").prop("checked", false);
      $(".lmar_core1_4").prop("checked", false);
      $(".lmar_core1_5").prop("checked", false);
      $(".lmar_core1_6").prop("checked", false);
      $(".lmar_core1_7").prop("checked", false);
      $(".lmar_core1_8").prop("checked", false);



      $('.checkall2').prop("checked", false);
      $(".lmar_core2_1").prop("checked", false);
      $(".lmar_core2_2").prop("checked", false);
      $(".lmar_core2_3").prop("checked", false);
      $(".lmar_core2_4").prop("checked", false);
      $(".lmar_core2_5").prop("checked", false);
      $(".lmar_core2_6").prop("checked", false);
      $(".lmar_core2_7").prop("checked", false);
      $(".lmar_core2_8").prop("checked", false);

      $('.checkall3').prop("checked", false);
      $(".lmar_core3_1").prop("checked", false);
      $(".lmar_core3_2").prop("checked", false);
      $(".lmar_core3_3").prop("checked", false);
      $(".lmar_core3_4").prop("checked", false);
      $(".lmar_core3_5").prop("checked", false);
      $(".lmar_core3_6").prop("checked", false);
      $(".lmar_core3_7").prop("checked", false);
      $(".lmar_core3_8").prop("checked", false);


      $('.checkall4').prop("checked", false);
      $(".lmar_core4_1").prop("checked", false);
      $(".lmar_core4_2").prop("checked", false);
      $(".lmar_core4_3").prop("checked", false);
      $(".lmar_core4_4").prop("checked", false);
      $(".lmar_core4_5").prop("checked", false);
      $(".lmar_core4_6").prop("checked", false);
      $(".lmar_core4_7").prop("checked", false);
      $(".lmar_core4_8").prop("checked", false);

      $('.checkall5').prop("checked", false);
      $(".lmar_core5_1").prop("checked", false);
      $(".lmar_core5_2").prop("checked", false);
      $(".lmar_core5_3").prop("checked", false);
      $(".lmar_core5_4").prop("checked", false);
      $(".lmar_core5_5").prop("checked", false);
      $(".lmar_core5_6").prop("checked", false);
      $(".lmar_core5_7").prop("checked", false);
      $(".lmar_core5_8").prop("checked", false);

      $('.checkall6').prop("checked", false);
      $(".lmar_core6_1").prop("checked", false);
      $(".lmar_core6_2").prop("checked", false);
      $(".lmar_core6_3").prop("checked", false);
      $(".lmar_core6_4").prop("checked", false);
      $(".lmar_core6_5").prop("checked", false);
      $(".lmar_core6_6").prop("checked", false);
      $(".lmar_core6_7").prop("checked", false);
      $(".lmar_core6_8").prop("checked", false);


      $('.checkall7').prop("checked", false);
      $(".lmar_core7_1").prop("checked", false);
      $(".lmar_core7_2").prop("checked", false);
      $(".lmar_core7_3").prop("checked", false);
      $(".lmar_core7_4").prop("checked", false);
      $(".lmar_core7_5").prop("checked", false);
      $(".lmar_core7_6").prop("checked", false);
      $(".lmar_core7_7").prop("checked", false);
      $(".lmar_core7_8").prop("checked", false);

      
      $('.checkall8').prop("checked", false);
      $(".lmar_core8_1").prop("checked", false);
      $(".lmar_core8_2").prop("checked", false);
      $(".lmar_core8_3").prop("checked", false);
      $(".lmar_core8_4").prop("checked", false);
      $(".lmar_core8_5").prop("checked", false);
      $(".lmar_core8_6").prop("checked", false);
      $(".lmar_core8_7").prop("checked", false);
      $(".lmar_core8_8").prop("checked", false);

            
      $('.checkall9').prop("checked", false);
      $(".lmar_core9_1").prop("checked", false);
      $(".lmar_core9_2").prop("checked", false);
      $(".lmar_core9_3").prop("checked", false);
      $(".lmar_core9_4").prop("checked", false);
      $(".lmar_core9_5").prop("checked", false);
      $(".lmar_core9_6").prop("checked", false);
      $(".lmar_core9_7").prop("checked", false);
      $(".lmar_core9_8").prop("checked", false);
...
var finalelemcom1
  ...
  <?php
$countperquery = "SELECT lmar_element_unit,COUNT(lmar_element_unit) as totalelem FROM `lmar_element` WHERE lmar_element_comp = '3' AND lmar_element_quali = '$sessionqualification' GROUP BY (lmar_element_unit)";
...
while($countss = mysqli_fetch_array($countpersql)){ 
    ...
    while($countloop <= $counting){ ?>
      if(trainee.lmar_core<?=$elementsloopings?>_<?=$countloop?> == '/'){
...
if(finalelemcom3 == 'uncheking'){
  ...
  // if(trainee.lmar_eimncii_core1_1 == '/' && trainee.lmar_eimncii_core1_2 == '/' && trainee.lmar_eimncii_core1_3 == '/' && trainee.lmar_eimncii_core1_4 == '/' && trainee.lmar_eimncii_core2_1 == '/' && trainee.lmar_eimncii_core2_2== '/' && trainee.lmar_eimncii_core2_3 == '/' && trainee.lmar_eimncii_core3_1 == '/' && trainee.lmar_eimncii_core3_2 == '/' && trainee.lmar_eimncii_core3_3 == '/' && trainee.lmar_eimncii_core3_4 == '/' && trainee.lmar_eimncii_core4_1 == '/' && trainee.lmar_eimncii_core4_2 == '/' && trainee.lmar_eimncii_core4_3 == '/' && trainee.lmar_eimncii_core5_1 == '/' && trainee.lmar_eimncii_core5_2 == '/' && trainee.lmar_eimncii_core5_3 == '/'){
  ...
  // if(trainee.lmar_eimncii_core1_1 == '/' && trainee.lmar_eimncii_core1_2 == '/' && trainee.lmar_eimncii_core1_3 == '/' && trainee.lmar_eimncii_core1_4 == '/' ){
  ...
  // if(trainee.lmar_eimncii_core2_1 == '/' && trainee.lmar_eimncii_core2_2 == '/' && trainee.lmar_eimncii_core2_3 == '/' ){
  ...
  // if(trainee.lmar_eimncii_core3_1 == '/' && trainee.lmar_eimncii_core3_2 == '/' && trainee.lmar_eimncii_core3_3 == '/' && trainee.lmar_eimncii_core3_4 == '/' ){
  ...
  // if(trainee.lmar_eimncii_core4_1 == '/' && trainee.lmar_eimncii_core4_2 == '/' && trainee.lmar_eimncii_core4_3 == '/' ){
  ...
  // if(trainee.lmar_eimncii_core5_1 == '/' && trainee.lmar_eimncii_core5_2 == '/' && trainee.lmar_eimncii_core5_3 == '/' ){
  ...
  $('#updatecom').on('click',function(){
    ...
    var isChecked1_1 = $('.lmar_core1_1').is(':checked'); 
    var isChecked1_2 = $('.lmar_core1_2').is(':checked'); 
    var isChecked1_3 = $('.lmar_core1_3').is(':checked'); 
    var isChecked1_4 = $('.lmar_core1_4').is(':checked');
    var isChecked1_5 = $('.lmar_core1_5').is(':checked');
    var isChecked1_6 = $('.lmar_core1_6').is(':checked');
    var isChecked1_7 = $('.lmar_core1_7').is(':checked');
    var isChecked1_8 = $('.lmar_core1_8').is(':checked');

    var isChecked2_1 = $('.lmar_core2_1').is(':checked'); 
    var isChecked2_2 = $('.lmar_core2_2').is(':checked'); 
    var isChecked2_3 = $('.lmar_core2_3').is(':checked'); 
    var isChecked2_4 = $('.lmar_core2_4').is(':checked');
    var isChecked2_5 = $('.lmar_core2_5').is(':checked');
    var isChecked2_6 = $('.lmar_core2_6').is(':checked');
    var isChecked2_7 = $('.lmar_core2_7').is(':checked');
    var isChecked2_8 = $('.lmar_core2_8').is(':checked');

    var isChecked3_1 = $('.lmar_core3_1').is(':checked'); 
    var isChecked3_2 = $('.lmar_core3_2').is(':checked'); 
    var isChecked3_3 = $('.lmar_core3_3').is(':checked'); 
    var isChecked3_4 = $('.lmar_core3_4').is(':checked');
    var isChecked3_5 = $('.lmar_core3_5').is(':checked');
    var isChecked3_6 = $('.lmar_core3_6').is(':checked');
    var isChecked3_7 = $('.lmar_core3_7').is(':checked');
    var isChecked3_8 = $('.lmar_core3_8').is(':checked');

    var isChecked4_1 = $('.lmar_core4_1').is(':checked'); 
    var isChecked4_2 = $('.lmar_core4_2').is(':checked'); 
    var isChecked4_3 = $('.lmar_core4_3').is(':checked'); 
    var isChecked4_4 = $('.lmar_core4_4').is(':checked');
    var isChecked4_5 = $('.lmar_core4_5').is(':checked');
    var isChecked4_6 = $('.lmar_core4_6').is(':checked');
    var isChecked4_7 = $('.lmar_core4_7').is(':checked');
    var isChecked4_8 = $('.lmar_core4_8').is(':checked');

    var isChecked5_1 = $('.lmar_core5_1').is(':checked'); 
    var isChecked5_2 = $('.lmar_core5_2').is(':checked'); 
    var isChecked5_3 = $('.lmar_core5_3').is(':checked'); 
    var isChecked5_4 = $('.lmar_core5_4').is(':checked');
    var isChecked5_5 = $('.lmar_core5_5').is(':checked');
    var isChecked5_6 = $('.lmar_core5_6').is(':checked');
    var isChecked5_7 = $('.lmar_core5_7').is(':checked');
    var isChecked5_8 = $('.lmar_core5_8').is(':checked');

    var isChecked6_1 = $('.lmar_core6_1').is(':checked'); 
    var isChecked6_2 = $('.lmar_core6_2').is(':checked'); 
    var isChecked6_3 = $('.lmar_core6_3').is(':checked'); 
    var isChecked6_4 = $('.lmar_core6_4').is(':checked');
    var isChecked6_5 = $('.lmar_core6_5').is(':checked');
    var isChecked6_6 = $('.lmar_core6_6').is(':checked');
    var isChecked6_7 = $('.lmar_core6_7').is(':checked');
    var isChecked6_8 = $('.lmar_core6_8').is(':checked');


    var isChecked7_1 = $('.lmar_core7_1').is(':checked'); 
    var isChecked7_2 = $('.lmar_core7_2').is(':checked'); 
    var isChecked7_3 = $('.lmar_core7_3').is(':checked'); 
    var isChecked7_4 = $('.lmar_core7_4').is(':checked');
    var isChecked7_5 = $('.lmar_core7_5').is(':checked');
    var isChecked7_6 = $('.lmar_core7_6').is(':checked');
    var isChecked7_7 = $('.lmar_core7_7').is(':checked');
    var isChecked7_8 = $('.lmar_core7_8').is(':checked');


    var isChecked8_1 = $('.lmar_core8_1').is(':checked'); 
    var isChecked8_2 = $('.lmar_core8_2').is(':checked'); 
    var isChecked8_3 = $('.lmar_core8_3').is(':checked'); 
    var isChecked8_4 = $('.lmar_core8_4').is(':checked');
    var isChecked8_5 = $('.lmar_core8_5').is(':checked');
    var isChecked8_6 = $('.lmar_core8_6').is(':checked');
    var isChecked8_7 = $('.lmar_core8_7').is(':checked');
    var isChecked8_8 = $('.lmar_core8_8').is(':checked');

    var isChecked9_1 = $('.lmar_core9_1').is(':checked'); 
    var isChecked9_2 = $('.lmar_core9_2').is(':checked'); 
    var isChecked9_3 = $('.lmar_core9_3').is(':checked'); 
    var isChecked9_4 = $('.lmar_core9_4').is(':checked');
    var isChecked9_5 = $('.lmar_core9_5').is(':checked');
    var isChecked9_6 = $('.lmar_core9_6').is(':checked');
    var isChecked9_7 = $('.lmar_core9_7').is(':checked');
    var isChecked9_8 = $('.lmar_core9_8').is(':checked');
  ...
  // }
    ...
    <?php 
        ...
        if(mysqli_num_rows($result) > 0){
          ...
          $loopchecking = '1';
          $loopelementing = '1';
          $selectingquery = "SELECT * FROM `lmar_unit_competencies` WHERE lmar_unit_qualification = '$sessionqualification' AND lmar_unit_comp = '3' ";
          ...
          if(com<?=$loopchecking?>_<?=$loopelementing?> == '/'){
            ...
            finalcom<?=$loopchecking?> = 'check'

          }
          else{
            console.log('no'+<?=$loopchecking?>_<?=$loopelementing?>)
            finalcom<?=$loopchecking?> = 'uncheck'
          } 
          ...
          console.log(<?=$loopchecking?>,finalcom<?=$loopchecking?>,'wow')
         <?php
    ...
    if(finalcom1 == 'uncheck'){
      finalsend1 = ''
    }
    else if(finalcom1 == 'check'){
      finalsend1 = '/'
    }
    else{
      finalsend1 = ''
    ...
    if(finalcom2 == 'uncheck'){
      finalsend2 = ''
    }
    else if(finalcom2 == 'check'){
      finalsend2 = '/'
    }
    else{
      finalsend2 = ''
    }
    if(finalcom3 == 'uncheck'){
      finalsend3 = ''
    }
    else if(finalcom3 == 'check'){
      finalsend3 = '/'
    }
    else{
      finalsend3 = ''
    }
    if(finalcom4 == 'uncheck'){
      finalsend4 = ''
    }
    else if(finalcom4 == 'check'){
      finalsend4 = '/'
    }
    else{
      finalsend4 = ''
    }
    if(finalcom5 == 'uncheck'){
      finalsend5 = ''
    }
    else if(finalcom5 == 'check'){
      finalsend5 = '/'
    }
    else{
      finalsend5 = ''
    }
    if(finalcom6 == 'uncheck'){
      finalsend6 = ''
    }
    else if(finalcom6 == 'check'){
      finalsend6 = '/'
    }
    else{
      finalsend6 = ''
    }
    if(finalcom7 == 'uncheck'){
      finalsend7 = ''
    }
    else if(finalcom7 == 'check'){
      finalsend7 = '/'
    }
    else{
      finalsend7 = ''
    }
    if(finalcom8 == 'uncheck'){
      finalsend8 = ''
    }
    else if(finalcom8 == 'check'){
      finalsend8 = '/'
    }
    else{
      finalsend8 = ''
    ...
    console.log('grr'+finalsend1)
    console.log('grr'+finalsend2)
    console.log('grr'+finalsend3)
    console.log('grr'+finalsend4)
    console.log('grr'+finalsend5)
    console.log('grr'+finalsend6)
    console.log('grr'+finalsend7)
    console.log('grr'+finalsend8)
    ...
    $.ajax({
      ...
      edit_core:edit_core,
        trainessid:trainessid,
        finalsend1:finalsend1,
        finalsend2:finalsend2,
        finalsend3:finalsend3,
        finalsend4:finalsend4,
        finalsend5:finalsend5,
        finalsend6:finalsend6,
        com1_1:com1_1,
        com1_2:com1_2,
        com1_3:com1_3,
        com1_4:com1_4,
