...
<div class="row bg-white py-2" id="printcommitment">
...
<div class="col-10 bg-secondary bg-opacity-50">
      ...
      <div class="col-5 mt-5 d-flex me-5 pe-3 mb-3">
          <div class="col-2 text-center text-white mt-2">
            <p class="bg-primary px-1 myf-custome6-font rounded-1" style="transform: rotate(-0.25turn);">annex-i</p>
          </div>
          ...
          <span class="ps-3 text-white myf-custome6-font" style="font-size:13px;"><em>Annex-i Commitment of Undertaking </em></span> 
          <br>
          ...
          <div class="row d-flex ms-5 mt-3 mb-3">
            <div class="col-8 offset-1 d-flex gap-2 justify-content-end">
              ...
              <button class="btn btn-primary" id="annexibtn"> <i class="fas fa-print"></i> Print </button></div>
            <div class="form-outline form-white col-2" style="width:18%;">
            <input type="number"  id="annexicount"  class="form-control" value="25"/>
            <label class="form-label" for="annexicount">Count</label>
          </div>
    ...
    <script src="../javascript/annexi.js"></script>
    <script>
