...
<div class="row number m-0 ms-3" style="height:100vh">
    <?php
        ...
        while($trainer_details_row = mysqli_fetch_array($trainer_details_sql)){ ?>
            ...
            <thead class="border-dark">
                <tr class="border-dark" style="height: 13px; font-size:8px" >
                    ...
                    <th class="p-0 text-center py-1" rowspan="2" style="width:14%; font-size:8px;">Name of Trainee (Surname,Firstname,Middlename)</th>
         ...
         <?php
            ...
            $row = 25;
            while($row >= $loop){
                echo '<tr class="border-dark text-center" style="height: 13px; font-size:8px">';
          ...
          ?>
            ...
            <div class="row m-0">
                ...
                <div class="row mt-2">
                        <u><span style="font-size:11px; font-weight:bold;">&nbsp&nbsp&nbsp&nbsp RHEO HENRY M. RODRIGUEZ &nbsp&nbsp&nbsp&nbsp</span></u>
                        
                    </div>
                    <div class="row" style="margin-top:-5px; margin-left:40px;">
